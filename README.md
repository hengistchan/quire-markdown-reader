...
The native Firefox shortcut gate runs in a Linux display session with `xvfb-run -a npm run test:e2e:firefox:native`. See the [v0.0.7 acceptance matrix](docs/acceptance-v0.0.7.md) for the current iteration boundary; earlier matrices remain as historical evidence.

...
export function OutlinePopover({ headings, activeId, progress, t, onJump }: {
  ...
  return <aside className="outline-popover" aria-label={t('outline')}>
    <label>{t('onThisPage')}</label>
    <nav ref={navRef}>{headings.map((heading) => (

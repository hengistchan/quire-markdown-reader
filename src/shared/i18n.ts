...
const en = {
  ...
  files: 'Files', outline: 'Outline', workspace: 'Workspace', onThisPage: 'On this page', sections: 'sections', noOutline: 'This document has no headings yet.',
  ...
  markdown: 'Markdown', mathematics: 'Mathematics', mathDescription: 'Render KaTeX expressions', diagrams: 'Diagrams', diagramDescription: 'Render Mermaid blocks', diagramRenderError: 'This diagram could not be rendered. The Mermaid source is shown below.', readingProgress: 'Reading progress', progressDescription: 'Show a fine progress line', autoRefresh: 'Auto refresh', refreshDescription: 'Watch the current document for changes', rawHtml: 'Raw HTML', htmlDescription: 'Sanitized before display', loadRemoteImages: 'Remote images', remoteImagesDescription: 'Load images hosted outside this device', imageReferrerPolicy: 'Image referrer', noReferrer: 'No referrer', originReferrer: 'Origin only', customCss: 'Custom CSS', cssNote: 'Scoped to the document. Changes are saved automatically.', language: 'Language', system: 'System', light: 'Light', dark: 'Dark',
  ...
  restoreTitle: 'Restore your workspace?', restoreBody: 'Quire remembers the folder, but your browser requires a click before access can resume.', restore: 'Restore workspace', refreshWorkspace: 'Refresh workspace', collapseAllFolders: 'Collapse all folders', expandAllFolders: 'Expand all folders', workspaceRefreshed: 'Workspace refreshed', scanningWorkspace: 'Scanning workspace…', workspaceScanLimit: 'Workspace scanning stopped at its safety limit. Choose a smaller folder.', dismiss: 'Not now',
  fileTypeError: 'Choose a Markdown file: .md, .markdown, or .mdx.', fileReadError: 'Quire could not read that file. Check its permission and try again.', folderUnsupported: 'This browser cannot open entire folders. You can still open individual Markdown files.', noMarkdown: 'No Markdown files were found in this folder.', folderReadError: 'Quire could not read that folder. Check its permission and try again.', permissionDenied: 'Access was not granted. Quire did not read anything from that location.', permissionRequired: 'This document needs your permission before Quire can restore it.', importedUnavailable: 'This temporary imported document is no longer available in this tab session.', unavailableDocument: 'Document unavailable', restoreDocument: 'Restore access', linkedFileMissing: 'That linked Markdown file was not found in this workspace.', invalidUrl: 'Enter a valid HTTP or HTTPS Markdown URL.', remoteReadError: 'Quire could not load that URL. Check your connection and try again.', remoteTimeout: 'The remote Markdown request timed out.', remoteServerError: 'The server returned HTTP', remoteTooLarge: 'The Markdown file is larger than 5 MB.', updated: 'Document refreshed', watching: 'Watching for changes', hideSidebar: 'Hide sidebar', showSidebar: 'Show sidebar', closeSettings: 'Close settings', close: 'Close', dismissNotice: 'Dismiss notification', documentNavigation: 'Document navigation', resourceUnavailable: 'resource unavailable', untitledSection: 'Untitled section',
  openContent: 'Open content', commandCenter: 'Command center', commandPlaceholder: 'Type a command, filename, or URL…', searchRecentlyOpened: 'Search recently opened…', commands: 'Commands', recentlyOpened: 'Recently opened', viewAllRecent: 'View all recent…', removeFromRecent: 'Remove from recent', workspaceFiles: 'Workspace files', line: 'Line', moreActions: 'More actions', filterFiles: 'Filter files…', toggleWorkspace: 'Toggle file workspace', toggleOutline: 'Toggle document outline', enableWideView: 'Use wider reading width', disableWideView: 'Use standard reading width', quietMode: 'Enter quiet reading mode', useLightTheme: 'Use light theme', useDarkTheme: 'Use dark theme', minuteRead: 'min read', readingAids: 'Reading aids', floatingOutline: 'Document outline', outlineDescription: 'Open the current document structure from the left rail', markdownExtensions: 'Markdown extensions', advanced: 'Advanced', settingsLive: 'Changes apply to the current document immediately.', resetSettings: 'Restore defaults', savedLocally: 'Saved on this device', noCommandResults: 'No matching commands or documents.', currentDocument: 'Current document', closeCommand: 'Close command center',
  ...
  copyCode: 'Copy code', copied: 'Copied', copyFailed: 'Copy failed', diagramControls: 'Diagram controls', expandDiagram: 'Expand diagram', closeLightbox: 'Close expanded diagram', interactiveDiagram: 'Interactive diagram. Drag to move, or use zoom and the arrow keys to explore.', zoomIn: 'Zoom in', zoomOut: 'Zoom out', resetZoom: 'Reset zoom',
...
const zh: Record<keyof typeof en, string> = {
  ...
  files: '文件', outline: '大纲', workspace: '工作区', onThisPage: '当前文档', sections: '个章节', noOutline: '当前文档还没有标题。',
  ...
  markdown: 'Markdown', mathematics: '数学公式', mathDescription: '渲染 KaTeX 表达式', diagrams: '图表', diagramDescription: '渲染 Mermaid 代码块', diagramRenderError: '该图表无法渲染，下面保留了 Mermaid 源码。', readingProgress: '阅读进度', progressDescription: '显示顶部进度细线', autoRefresh: '自动刷新', refreshDescription: '监听当前文档的变化', rawHtml: '原始 HTML', htmlDescription: '显示前进行安全清洗', loadRemoteImages: '远程图片', remoteImagesDescription: '加载托管在本机之外的图片', imageReferrerPolicy: '图片来源信息', noReferrer: '不发送来源', originReferrer: '仅发送站点来源', customCss: '自定义 CSS', cssNote: '仅作用于文档区域，并自动保存。', language: '语言', system: '跟随系统', light: '浅色', dark: '深色',
  ...
  restoreTitle: '恢复上次的工作区？', restoreBody: 'Quire 记住了该文件夹，但浏览器要求你点击后才能重新授权。', restore: '恢复工作区', refreshWorkspace: '刷新工作区', collapseAllFolders: '收起所有文件夹', expandAllFolders: '展开所有文件夹', workspaceRefreshed: '工作区已刷新', scanningWorkspace: '正在扫描工作区…', workspaceScanLimit: '工作区扫描已达到安全上限，请选择更小的文件夹。', dismiss: '暂不恢复',
  fileTypeError: '请选择 .md、.markdown 或 .mdx 文件。', fileReadError: 'Quire 无法读取该文件，请检查权限后重试。', folderUnsupported: '当前浏览器不能打开整个文件夹，但仍可打开单个 Markdown 文件。', noMarkdown: '这个文件夹中没有找到 Markdown 文件。', folderReadError: 'Quire 无法读取该文件夹，请检查权限后重试。', permissionDenied: '未获得访问权限，Quire 没有读取该位置的任何内容。', permissionRequired: 'Quire 需要你授权后才能恢复这篇文档。', importedUnavailable: '这篇临时导入的文档已不在当前标签页会话中。', unavailableDocument: '文档不可用', restoreDocument: '恢复访问', linkedFileMissing: '工作区中没有找到这个 Markdown 链接指向的文件。', invalidUrl: '请输入有效的 HTTP 或 HTTPS Markdown 地址。', remoteReadError: 'Quire 无法加载这个网址，请检查网络后重试。', remoteTimeout: '加载网络 Markdown 超时。', remoteServerError: '服务器返回了 HTTP', remoteTooLarge: 'Markdown 文件超过 5 MB。', updated: '文档已刷新', watching: '正在监听变化', hideSidebar: '隐藏侧栏', showSidebar: '显示侧栏', closeSettings: '关闭设置', close: '关闭', dismissNotice: '关闭通知', documentNavigation: '文档导航', resourceUnavailable: '资源不可用', untitledSection: '未命名章节',
  openContent: '打开内容', commandCenter: '命令中心', commandPlaceholder: '输入命令、文件名或 URL…', searchRecentlyOpened: '搜索最近打开的资源…', commands: '操作', recentlyOpened: '最近打开', viewAllRecent: '查看全部最近记录…', removeFromRecent: '从最近记录中移除', workspaceFiles: '工作区文件', line: '第', moreActions: '更多操作', filterFiles: '筛选文件…', toggleWorkspace: '切换文件工作区', toggleOutline: '切换文档大纲', enableWideView: '开启较宽展示', disableWideView: '恢复标准宽度', quietMode: '进入安静阅读模式', useLightTheme: '切换浅色主题', useDarkTheme: '切换深色主题', minuteRead: '分钟阅读', readingAids: '阅读辅助', floatingOutline: '文档大纲', outlineDescription: '从左侧导航轨展开当前文档结构', markdownExtensions: 'Markdown 扩展', advanced: '高级', settingsLive: '修改后立即应用到当前文档。', resetSettings: '恢复默认设置', savedLocally: '设置保存在此设备', noCommandResults: '没有匹配的命令或文档。', currentDocument: '当前文档', closeCommand: '关闭命令中心',
  ...
  copyCode: '复制代码', copied: '已复制', copyFailed: '复制失败', diagramControls: '图表控制', expandDiagram: '全屏图表', closeLightbox: '关闭全屏图表', interactiveDiagram: '交互式图表。可直接拖拽，也可使用缩放与方向键浏览。', zoomIn: '放大', zoomOut: '缩小', resetZoom: '重置缩放',

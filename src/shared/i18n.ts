...
const zh: Record<keyof typeof en, string> = {
  ...
  openContent: '打开内容', commandCenter: '命令中心', commandPlaceholder: '输入命令、文件名或 URL…', commands: '操作', recentlyOpened: '最近打开', moreActions: '更多操作', filterFiles: '筛选文件…', toggleWorkspace: '切换文件工作区', toggleOutline: '切换文档大纲', quietMode: '进入安静阅读模式', useLightTheme: '切换浅色主题', useDarkTheme: '切换深色主题', readingNote: '工程笔记', minuteRead: '分钟阅读', readingAids: '阅读辅助', floatingOutline: '右侧悬浮大纲', outlineDescription: '在阅读时随时查看当前文档结构', markdownExtensions: 'Markdown 扩展', advanced: '高级', settingsLive: '修改后立即应用到当前文档。', resetSettings: '恢复默认设置', savedLocally: '设置保存在此设备', noCommandResults: '没有匹配的命令或文档。', currentDocument: '当前文档', closeCommand: '关闭命令中心',

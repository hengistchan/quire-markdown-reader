...
const en = {
  ...
  urlTitle: 'Open Markdown from the web', urlDescription: 'Quire requests access only to this website. The permission can be removed from your browser settings.', urlPlaceholder: 'https://example.com/guide.md', loadingRemote: 'Loading Markdown…', cancel: 'Cancel', open: 'Open',
...
const zh: Record<keyof typeof en, string> = {
  ...
  urlTitle: '打开网络 Markdown', urlDescription: 'Quire 只请求当前网站的访问权限，你可以随时在浏览器设置中移除。', urlPlaceholder: 'https://example.com/guide.md', loadingRemote: '正在加载 Markdown…', cancel: '取消', open: '打开',
  restoreTitle: '恢复上次的工作区？', restoreBody: 'Quire 记住了该文件夹，但浏览器要求你点击后才能重新授权。', restore: '恢复工作区', dismiss: '暂不恢复',
  fileTypeError: '请选择 .md、.markdown 或 .mdx 文件。', fileReadError: 'Quire 无法读取该文件，请检查权限后重试。', folderUnsupported: '当前浏览器不能打开整个文件夹，但仍可打开单个 Markdown 文件。', noMarkdown: '这个文件夹中没有找到 Markdown 文件。', folderReadError: 'Quire 无法读取该文件夹，请检查权限后重试。', permissionDenied: '未获得访问权限，Quire 没有读取该位置的任何内容。', linkedFileMissing: '工作区中没有找到这个 Markdown 链接指向的文件。', invalidUrl: '请输入有效的 HTTP 或 HTTPS Markdown 地址。', remoteReadError: 'Quire 无法加载这个网址。', remoteServerError: '服务器返回了 HTTP', remoteTooLarge: 'Markdown 文件超过 5 MB。', updated: '文档已刷新', watching: '正在监听变化', hideSidebar: '隐藏侧栏', showSidebar: '显示侧栏', closeSettings: '关闭设置', close: '关闭', dismissNotice: '关闭通知', documentNavigation: '文档导航', resourceUnavailable: '资源不可用', untitledSection: '未命名章节',
  openContent: '打开内容', commandCenter: '命令中心', commandPlaceholder: '输入命令、文件名或 URL…', commands: '操作', recentlyOpened: '最近打开', moreActions: '更多操作', filterFiles: '筛选文件…', toggleWorkspace: '切换文件工作区', toggleOutline: '切换文档大纲', enableWideView: '开启较宽展示', disableWideView: '恢复标准宽度', quietMode: '进入安静阅读模式', useLightTheme: '切换浅色主题', useDarkTheme: '切换深色主题', minuteRead: '分钟阅读', readingAids: '阅读辅助', floatingOutline: '右侧悬浮大纲', outlineDescription: '在阅读时随时查看当前文档结构', markdownExtensions: 'Markdown 扩展', advanced: '高级', settingsLive: '修改后立即应用到当前文档。', resetSettings: '恢复默认设置', savedLocally: '设置保存在此设备', noCommandResults: '没有匹配的命令或文档。', currentDocument: '当前文档', closeCommand: '关闭命令中心',
  recent: '最近打开', fromWeb: '来自网络', localFile: '本地文件', imported: '导入的文档', gettingStarted: '开始使用', untitled: '未命名',
